// modified from https://github.com/abhiche/cls-redis-patch
'use strict';
...
module.exports = function patchRedis(nsName) {
  ...
  shimmer.wrap(proto, 'send_command', function (send_command) {
    return function wrapped() {
      ...
      // get the cls-hooked namespace with the predifined name
      // this namespace should've been created and populated (e.g. with correlationId) by one of the prviously called middleware in the chain
      const ns = getNamespace('requestContext');
